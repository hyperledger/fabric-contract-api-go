...
require (
	...
	github.com/hyperledger/fabric-chaincode-go v0.0.0-20191108205148-17c4b2760b56 // indirect
	github.com/hyperledger/fabric-protos-go v0.0.0-20191114160927-6bee4929a99f // indirect

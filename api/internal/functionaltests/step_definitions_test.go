...
import (
	...
	"github.com/hyperledger/fabric-contract-api-go/api"
	"github.com/hyperledger/fabric-contract-api-go/api/internal/functionaltests/contracts/complexcontract"
	"github.com/hyperledger/fabric-contract-api-go/api/internal/functionaltests/contracts/extendedsimplecontract"
	"github.com/hyperledger/fabric-contract-api-go/api/internal/functionaltests/contracts/simplecontract"
	"github.com/hyperledger/fabric-contract-api-go/api/internal/functionaltests/contracts/utils"
	"github.com/hyperledger/fabric-contract-api-go/api/metadata"
	"github.com/hyperledger/fabric-protos-go/peer"
)

var opt = godog.Options{Output: colors.Colored(os.Stdout)}

var contractsMap map[string]api.ContractInterface = map[string]api.ContractInterface{
...
type suiteContext struct {
	...
	chaincode      *api.ContractChaincode
...
func (sc *suiteContext) createChaincode(name string) error {
	...
	chaincode, err := api.NewChaincode(contractsMap[name])
...
func (sc *suiteContext) createChaincodeMulti(contractsTbl *gherkin.DataTable) error {
	...
	contracts := []api.ContractInterface{}
	...
	chaincode, err := api.NewChaincode(contracts...)
